              ...
              <div className="footer-info-box col-md-4 col-sm-12">
                <div className="info-inner">
                  <div className="content">
                    ...
                    <div className="text">
                      123 Main Street, <br /> Abe Garage Sefer
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="auto-container">
          <div className="footer-bottom">
            <div className="copyright-text">
              © Copyright <a href="#">AbeGarage 2025</a>. All right reserved.
            </div>
            <div className="text">
              Created by <a href="#">abeTheDeveloper</a>
            </div>
          </div>
        </div>
      </footer>
